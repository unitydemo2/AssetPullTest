...
Virtual axes and buttons can be created on the [Input](class-InputManager) window, and end users can configure Keyboard input in a nice screen configuration dialog.


![NOTE: This is a legacy image. This Input Selector image dates back to the very earliest versions of the Unity Editor in 2005. [GooBall](https://en.wikipedia.org/wiki/GooBall) was a Unity Technologies game.](../uploads/Main/InputSelector.jpg) 
