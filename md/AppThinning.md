...
In this example, the _Textures_ folder has been given the label _textures_. The new script __BuildiOSAssetBundles.cs__ has been created in the _Editor_ folder.
